...
| azurerm_mysql_flexible_server_active_directory_administrator.mysql_flexible_server_active_directory_administrator | resource |
...
| mysql_flexible_server_active_directory_administrator | Resource definition, default settings are defined within locals and merged with var settings. For more information look at [Outputs](#Outputs). | `any` | `{}` | no |
...
| mysql_flexible_server_active_directory_administrator | Outputs all attributes of resource_type. |
